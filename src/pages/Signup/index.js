...
const Copyright = () => {
  return (
    <Typography variant="body2" color="primary" align="center">
      {"Copyright "}
      <Link variant="colorTextSecondary" color="primary" href="#">
 				<strong> { nomeEmpresa } </strong> - v { versionSystem }
 			</Link>{" "}
    ...
    <div className="geral-signup">
      <div className={"container-signup"}>
        <div className={"paper"}>
          ...
          <div>
            <span className="span">
              👋🏻 Comece seu <b>teste GRATUITO</b> de 3 dias da <b>{ nomeEmpresa }</b> em
              apenas 3 etapas!{" "}
                ...
                <Grid>
                  <Grid item>
                    <Link
                      ...
                      to="/login"
                      style={{ color: "#367f48", fontWeight: 500 }}
                    >
